<aside class="sidebar">
  <ul>
    ...
    <!-- <li>
      ...
      <ul> -->
    <li class="not-ready" <?php if ($current_page == 'admin_users.php') echo 'class="active"'; ?>><a href="admin_users.php"><i class="bx bxs-user"></i>Users</a></li>
    <li class="not-ready" <?php if ($current_page == 'admin_products.php') echo 'class="active"'; ?>><a href="admin_products.php"><i class="bx bx-package"></i>Products</a></li>
    <li class="not-ready" <?php if ($current_page == 'admin_menu.php') echo 'class="active"'; ?>><a href="admin_menu.php"><i class="bx bx-category"></i>Today's Menu</a></li>
    ...
    <li <?php if ($current_page == 'admin_settings.php') echo 'class="active"'; ?>><a href="admin_settings.php"><i class="bx bx-cog"></i>Settings</a></li>
